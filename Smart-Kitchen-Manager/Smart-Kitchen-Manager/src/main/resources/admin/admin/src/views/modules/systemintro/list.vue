		...
		<template v-if="showFlag">
			<el-form class="search-form" :inline="true" :model="searchForm">
				...
				<el-row class="button-row">
					<el-button v-if="isAuth('systemintro','新增')" type="primary" @click="addOrUpdateHandler()">新增</el-button>
					<el-button v-if="isAuth('systemintro','删除')" :disabled="dataListSelections.length <= 0" type="danger" @click="deleteHandler()">删除</el-button>
				</el-row>
			</el-form>
			...
			<!-- <div> -->
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							<el-button v-if=" isAuth('systemintro','查看')" type="success" size="mini" @click="addOrUpdateHandler(scope.row.id,'info')">详情</el-button>
							<el-button v-if=" isAuth('systemintro','修改')" type="primary" size="mini" @click="addOrUpdateHandler(scope.row.id)">修改</el-button>
							<el-button v-if="isAuth('systemintro','删除') " type="danger" size="mini" @click="deleteHandler(scope.row.id)">删除</el-button>
						</template>
					</el-table-column>
				</el-table>
				<el-pagination
