	...
	<div class="menu-preview">
		...
		<el-scrollbar wrap-class="scrollbar-wrapper">
			<el-menu :default-openeds="[]" :unique-opened="true" :style='{"border":0,"padding":"0","listStyle":"none","margin":"40px 0px 20px","position":"relative","background":"linear-gradient(135deg, #667eea 0%, #764ba2 100%)"}' class="el-menu-vertical-demo" default-active="0">
				...
				<el-submenu index="1">
					<template slot="title">
						<i v-if='true' :style='{"width":"20px","verticalAlign":"middle","margin":"0 3px","fontSize":"20px","color":"inherit","textAlign":"center"}' class="el-icon-menu el-icon-user-solid" />
						<span :style='{"color":"inherit","verticalAlign":"middle","fontSize":"13px"}'>个人中心</span>
					</template>
				...
				<el-submenu v-for=" (menu,index) in menuList.backMenu" :key="menu.menu" :index="index+2+''">
					<template slot="title">
						<i v-if='true' :style='{"width":"20px","verticalAlign":"middle","margin":"0 3px","fontSize":"20px","color":"inherit","textAlign":"center"}' class="el-icon-menu" :class="icons[index]" />
						<span :style='{"color":"inherit","verticalAlign":"middle","fontSize":"13px"}'>{{ menu.menu }}</span>
					</template>
